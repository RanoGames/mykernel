/* syscall.h — Linux i386 syscall numbers (arch/x86/entry/syscalls/syscall_32.tbl) */
...
#define SYS_GETEUID         201  /* alias */
#define SYS_GETEGID32       202
#define SYS_GETEGID         202  /* alias */
